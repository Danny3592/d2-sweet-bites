    ...
    <main>
      ...
      <section className="index-news py-18 py-lg-36">
        <div className="container">
          ...
          <p className="mb-12 mb-lg-32">探索最新公益成果，與我們一起改變世界。</p>
          <div className="row mb-12">
            <div className="col-md-6 mb-6 mb-md-0">
              <div className="index-news__card position-relative pb-6 pb-md-0 border-bottom border-gray-400 border-bottom-md-0">
                <img className='object-fit-cover w-100 mb-2 mb-lg-3 h-xl-472px' 
                  src={newsImages1}
                  alt="newsImages1" />
                <p className='text-gray-700 fs-8 mb-2 mb-lg-3'>2024 年 12 月 24 日</p>
                <h3 className='fs-6 fs-lg-4 mb-2 mb-lg-3'>
                  一起分享幸福，送出500份溫暖餐點！
                </h3>
                <a href='#'
                  className='text-gray-700 fs-8 fs-lg-7 stretched-link'>您的甜點，正在改變世界。</a>
              </div>
            </div>
            <div className="col-md-6">
              <div className="index-news__card position-relative pb-6 border-bottom border-gray-400">
                <div className="row">
                  <div className="col-md-6">
                    <img className='object-fit-cover w-100 mb-2 mb-md-0' 
                    src={newsImages2}
                    alt="newsImages1" />
                  </div>
                  <div className="col ps-lg-1">
                    <p className='text-gray-700 fs-8 mb-2'>2024 年 9 月 28 日</p>
              ...
              <div className="index-news__card position-relative pt-6">
                <div className="row">
                  ...
                  <div className="col ps-lg-1">
                    <p className='text-gray-700 fs-8 mb-2'>2024 年 3 月 21 日</p>
                    <h3 className='fs-6 fs-md-7 fs-lg-6 mb-2'>
                      甜點與地球同行，種下100棵新希望！
                    </h3>
                    <a href='#'
          ...
          <div className="d-flex justify-content-center justify-content-md-end">
            <a href="#"
              className='btn text-primary-600 pe-lg-0'>
